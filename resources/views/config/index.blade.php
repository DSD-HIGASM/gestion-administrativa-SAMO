    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <a href="{{ route('config.jefatura') }}" class="flex flex-col p-5 bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md hover:border-pba-cyan/60 hover:-translate-y-1 transition-all duration-200 group text-center cursor-pointer">
                    <div class="w-12 h-12 mx-auto mb-4 rounded-xl bg-pba-cyan/10 flex items-center justify-center text-pba-cyan group-hover:bg-pba-cyan group-hover:text-white transition-colors">
